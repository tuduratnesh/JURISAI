    ...
    <div className="w-full bg-[#334EAC] relative px-5 py-3">
      <div className="flex items-center justify-between">
        ...
        <ul className="hidden md:flex space-x-10 text-white text-xl pr-4 items-center">
          ...
          <li>
            <a href="/documents" className="hover:text-yellow-400">
              Documents
            </a>
          </li>
          <li>
            <a href="/analytics" className="hover:text-yellow-400">
              Analytics
            </a>
          </li>
          <li>
            ...
            <button onClick={() => setIsProfileOpen(!isProfileOpen)}>
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM4.5 20.1a7.5 7.5 0 0115 0A17.933 17.933 0 0112 21.75c-2.7 0-5.2-.6-7.5-1.65Z"
                />
              </svg>
            </button>
          </li>
      ...
      {isProfileOpen && (
        <div className="absolute right-5 mt-4 w-72 bg-white border border-gray-200 rounded-lg shadow-lg p-2 z-50">
          ...
          <button
            className="w-full text-center text-blue-600 font-semibold py-2 hover:bg-gray-100"
